...
<h1 class="h1_center">Opdracht voor Jhudeska</h1>
<p class="p_description">Het is de bedoeling dat dit volledig weet te realiseren  met HTML 5 /CSS 3 als je eerste opdracht</p>
...
<div class="container">
    ...
    <div class="model-preview-block">
        ...
        <div class="model-preview-index-large last">
            <div class="title"><h2>OCTAVIA</h2></div>
            <div class="type">Comfort</div>
